...
function sanea($input, $tipo, $min_long, $max_long, $regexp = '') {
    ...
    if(isset($input) && strlen($input) >= $min_long){
            ...
            if($regexp == '' || preg_match($regexp, $output)) {
                ...
                switch ($tipo) {
                    ...
                    case 'int':
                        ...
                        break;
                    case 'float':
                        $output = filter_var($output, FILTER_SANITIZE_NUMBER_FLOAT);
                ...
                echo 'Error. El dato nno concuerda con el patr&oacute;n';
                $output = FALSE;
            }
        ...
        echo 'Error. El dato no esta definido o estas vacio';
        $output = FALSE;
    }
